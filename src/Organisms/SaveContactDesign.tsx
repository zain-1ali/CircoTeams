...
const SaveContactDesign = () => {
  ...
  return (
    <div className="w-[100%]   h-[320px] rounded-[20px] bg-[#F9F9F9] pl-4 xl:pl-7 pr-4 pt-6 mt-1 ">
      <Text
        text="Button Style"
        classes="font-[600] text-[12px] text-[#8D8D8D]"
      />
      <div className="flex gap-5 xl:gap-[13%] mt-2">
        <div
      ...
      <div className="flex gap-5 mt-4 xl:mt-7 xl:gap-[13%]">
        <div
