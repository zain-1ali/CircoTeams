    ...
    <div className="h-[100%] w-[17%] border bg-white flex justify-center items-center">
      <div className="h-[95%] w-[92%]  flex flex-col items-center">
        ...
        <div className="mt-8 w-[100%] flex flex-col gap-4 h-[60%] overflow-y-scroll">
          <SidebarButton icon={i1} hoverIcon={hi1} text="Profiles" />
          <SidebarButton icon={i2} hoverIcon={hi2} text="Team" />
          <SidebarButton icon={i3} hoverIcon={hi3} text="Connections" />
          <SidebarButton icon={i4} hoverIcon={i4} text="Analytics" />
          <SidebarButton icon={i5} hoverIcon={hi5} text="Devices" />
          <SidebarButton icon={i6} hoverIcon={hi6} text="Support" />
        </div>
      </div>
    </div>
  );
